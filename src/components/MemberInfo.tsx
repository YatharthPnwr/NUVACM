        ...
        >
            ...
            >
                <div className="relative h-full w-full">
                    ...
                    <div className="relative h-3/4 w-full p-4 pb-2">
                        ...
                        <div className={`z-50 absolute top-6 right-6 flex flex-col gap-2 transition-all duration-300 ${
                    ...
                    <div className="flex h-1/4 flex-col justify-center px-6 py-2 text-center">
                        <div className="mb-3">
                        ...
                        <div className="mb-3">
                            <p className="text-m font-bold text-[#FFD700]">
                                {props.position}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className={`absolute inset-0 rounded-2xl bg-gradient-to-t from-red-50/20 via-transparent to-transparent transition-opacity duration-300 ${
    ...
    return (
        ...
        >
            <div className="relative h-full w-full overflow-hidden rounded-2xl bg-white shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 border border-gray-100">
                ...
                {/* Hover Effect Border */}
                <div className={`absolute inset-0 rounded-2xl border-2 border-red-500/20 transition-opacity duration-300 ${
                    isHovered ? 'opacity-100' : 'opacity-0'
                }`} />
            </div>
        </div>
    ...
    return (
        <div className="container mx-auto px-4 py-12">
            <div className="mb-12 text-center">
                ...
                <p className="text-lg text-gray-600">The brilliant minds behind our success</p>
            </div>
